...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT id, usuario, correo, contraseña FROM user WHERE correo = ?";
...
<div class="scroll-down">Desliza hacia abajo
...
<div class="modal">
    <div class="modal-container">
        <div class="modal-left">
            ...
            <p class="modal-desc">"Con nuestra tecnología de medición de consumo eléctrico, podrás tomar el control de tu energía, reducir gastos innecesarios y contribuir al cuidado del planeta."</p>
            ...
            <div class="input-block">
                ...
                <input type="password" name="password" id="Ingresa tu contraseña" placeholder="Password">
            </div>
            <div class="modal-buttons">
                <a href="">Olvidaste tu contraseña</a>
                <button class="input-button"><a href="/electro/electro/" style="text-decoration: none; color:#ffff;">Ingresar</a></button>
            </div>
            <p class="sign-up">Aun no estas registrado? <a href="#">Crea cuenta ahora</a></p>
        </div>
    </form>
        <div class="modal-right">
            <img src="logitpo.png" style="width:350px;height:63%;margin-top:100px;" alt="logo">
        </div>
